...
public class GetLastPublicationTimeServiceImpl implements GetLastPublicationTimeService {
    ...
    public ZonedDateTime getLastPublicationTime() {
        try {
            ...
            log.info(LOG_FEIGN_CLIENT_GOT_LAST_PUBLICATION.formatted(serviceName, lastNews.getResult()));
